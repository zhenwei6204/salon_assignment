    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /* Service Details Layout - MODIFIED FOR VERTICAL LAYOUT */
            .service-details {
            ...
            .service-info {
                ...
                margin-bottom: 3rem; /* Add space before image */
            }
            ...
            /* Meta Info - MODIFIED FOR VERTICAL LAYOUT */
    .meta-info {
    display: grid;
                ...
                <div class="service-info">
                    ...
                    <div class="meta-info">
                        ...
                        <div class="meta-item">
                            ...
                            <div class="meta-value {{ $service->is_available ? 'availability-available' : 'availability-unavailable' }}">
...
@endif
            ...
            @if($service->stylist_qualifications)
            <div class="details-section animate-on-scroll">
            ...
            @else
                <button class="btn disabled" disabled>
                    <span><i class="fas fa-times"></i> Currently Unavailable</span>
                </button>
                <p class="booking-note">This service is temporarily unavailable</p>
            @endif
            </div>
